...
from src.utils.signature_checker import check_signature
import logging
...
def check_request():
    ...
    if signature_result == "obfuscated":
        from src.utils.preprocessor import extract_features
        from src.utils.ml_checker import check_ml_prediction
